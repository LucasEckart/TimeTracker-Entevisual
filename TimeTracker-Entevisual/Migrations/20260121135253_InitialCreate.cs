        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Titulo = table.Column<string>(type: "nvarchar(140)", maxLength: 140, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Actividades_TiposActividad_TipoActividadId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tiempos_Actividades_ActividadId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarcasTiempo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MarcasTiempo_Tiempos_TiempoId",
                        column: x => x.TiempoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarcasTiempo_TiempoId",
                table: "MarcasTiempo",
                column: "TiempoId");

            migrationBuilder.CreateIndex(
                name: "IX_Tiempos_ActividadId",
                table: "Tiempos",
                column: "ActividadId");
        }
